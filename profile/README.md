...
| [omega-prime-ros](https://github.com/ika-rwth-aachen/omega-prime-ros) | Dockerized ROS 2 conversion pipeline that converts bag files to [omega-prime](https://github.com/ika-rwth-aachen/omega-prime)  | <img src="https://img.shields.io/github/stars/ika-rwth-aachen/omega-prime-ros?style=social"/> | <img src="https://github.com/ika-rwth-aachen/omega-prime-ros/blob/main/omega-prime-ros.svg?raw=true" width="70" /> |
...
| [scenario quality checker](https://github.com/ika-rwth-aachen/scenario_quality_checker) | Analyze ASAM OpenSCENARIO files for structural, schema, and motion issues  | <img src="https://img.shields.io/github/stars/ika-rwth-aachen/scenario_quality_checker?style=social"/> | <img src="https://raw.githubusercontent.com/ika-rwth-aachen/scenario_quality_checker/refs/heads/main/assets/scenario_quality_checker.png" width="200" /> |
...
| [ROS2 MoGeV2 TensorRT Node](https://github.com/ika-rwth-aachen/ros2-moge-trt) | ROS2 MoGeV2 TensorRT Inference Node: *Metric Depth Estimation and Point Cloud Generation from Monocular Images* | <img src="https://img.shields.io/github/stars/ika-rwth-aachen/ros2-moge-trt?style=social"/> <br/> |  |
| [ROS2 DepthAnythingV3 TensorRT Node](https://github.com/ika-rwth-aachen/ros2-depth-anything-v3-trt) | ROS2 DepthAnythingV3 TensorRT Inference Node: *Metric Depth Estimation and Point Cloud Generation from Monocular Images* | <img src="https://img.shields.io/github/stars/ika-rwth-aachen/ros2-depth-anything-v3-trt?style=social"/> <br/> |  |
